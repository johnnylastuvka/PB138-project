    ...
    render() {
        return (
            <header className={"row header"}>
                <div className={"col-lg-3 header__title pointer"} onClick={(e) => {e.preventDefault(); this.resetMainContent();}}>
                ...
                <div className={"col-lg-4 header__search-buttons"}>
                    ...
                    <button
                        ...
                        onClick={(e) => { e.preventDefault(); this.changeSearchType("categories"); }}
                    >
                        Kategorie
                    </button>
                    ...
                    <button
                        ...
                        onClick={(e) => { e.preventDefault(); this.changeSearchType("attributes"); }}
                    >
                        Atributů
                    </button>
